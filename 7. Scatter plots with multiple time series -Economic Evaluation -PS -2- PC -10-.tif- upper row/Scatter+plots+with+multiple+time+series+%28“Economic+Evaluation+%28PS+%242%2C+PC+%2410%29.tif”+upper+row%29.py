...
plt.scatter(worse_points['dQALY'], worse_points['Centers'], c='black', marker='x', s=100)
...
best_base_prime.graph = plt.scatter(best_base_prime['dQALY'], 
                                     best_base_prime['Base Prime'], c='r', s=50, alpha = 0.3)
best_prevention_1.graph = plt.scatter(best_prevention_1['dQALY'], 
                                       best_prevention_1['Prevention 1'], c='g', s=50, alpha = 0.3)
best_prevention_2.graph = plt.scatter(best_prevention_2['dQALY'], 
                                       best_prevention_2['Prevention 2'], c='b', s=50, alpha = 0.3)
plt.plot(best_frontier['dQALY'], best_frontier['Frontier'], color = 'black', alpha = 0.6, linewidth = 3)
plt.scatter(best_points['dQALY'], best_points['Centers'], c='black', marker='x', s=100)
